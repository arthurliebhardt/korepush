  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={`flex w-full items-center rounded-md p-1.5 text-left transition-colors hover:bg-surface-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background ${
      ...
      {open && (
        <div
          ...
          className={`surface-overlay absolute bottom-[calc(100%+6px)] z-40 overflow-hidden p-1 ${
